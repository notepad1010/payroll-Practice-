  ...
  return (
    <div className="w-64 bg-blue-900 min-h-screen flex flex-col">
      ...
      <div className="px-3 py-4 border-t border-blue-800">
        <button
          onClick={logout}
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-blue-200 hover:bg-blue-800 hover:text-white transition-colors duration-200 w-full"
        >
