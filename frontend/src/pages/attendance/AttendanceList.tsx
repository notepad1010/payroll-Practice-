...
export default function AttendanceList() {
  const { data: records, isLoading, isError } = useAttendanceList();
      ...
      <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {deleteTarget
                ? `This will permanently delete the record for ${empName(deleteTarget.employee)} on ${deleteTarget.work_date}.`
                : ''}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={handleDelete} disabled={deleteAttendance.isPending}>
